...
// Capturar error de login si viene de redirección
$error_msg = "";
...
<head>
    ...
    <style>
    /* MODAL - mismos estilos que index.php */
    .modal {
        display: none;
        position: fixed;
        z-index: 100;
...
<section class="alquiler-section alquiler-bg">
    ...
    <div class="maquinaria-grid">
        ...
        <div class="card">
            ...
            <?php if(isset($_SESSION['usuario'])): ?>
                <a href="<?php echo generarWhatsApp('Excavadora', 'mensual, diaria o por horas'); ?>" target="_blank"><button>Alquilar</button></a>
            <?php else: ?>
                <button onclick="abrirModal('login')">Alquilar</button>
            <?php endif; ?>
        </div>
        ...
        <div class="card">
            ...
            <?php if(isset($_SESSION['usuario'])): ?>
                <a href="<?php echo generarWhatsApp('Retroexcavadora', 'mensual, diaria o por horas'); ?>" target="_blank"><button>Alquilar</button></a>
            <?php else: ?>
                <button onclick="abrirModal('login')">Alquilar</button>
            <?php endif; ?>
        </div>
        ...
        <div class="card">
            ...
            <?php if(isset($_SESSION['usuario'])): ?>
                <a href="<?php echo generarWhatsApp('Cargador Frontal', 'mensual, diaria o por horas'); ?>" target="_blank"><button>Alquilar</button></a>
            <?php else: ?>
                <button onclick="abrirModal('login')">Alquilar</button>
            <?php endif; ?>
        </div>
        ...
        <div class="card">
            ...
            <?php if(isset($_SESSION['usuario'])): ?>
                <a href="<?php echo generarWhatsApp('Grúa', 'mensual, diaria o por horas'); ?>" target="_blank"><button>Alquilar</button></a>
            <?php else: ?>
                <button onclick="abrirModal('login')">Alquilar</button>
            <?php endif; ?>
        </div>
        ...
        <div class="card">
            ...
            <?php if(isset($_SESSION['usuario'])): ?>
                <a href="<?php echo generarWhatsApp('Compactador', 'mensual, diaria o por horas'); ?>" target="_blank"><button>Alquilar</button></a>
            <?php else: ?>
                <button onclick="abrirModal('login')">Alquilar</button>
            <?php endif; ?>
        </div>
        ...
        <div class="card">
            ...
            <?php if(isset($_SESSION['usuario'])): ?>
                <a href="<?php echo generarWhatsApp('Generador Eléctrico', 'mensual, diaria o por horas'); ?>" target="_blank"><button>Alquilar</button></a>
            <?php else: ?>
                <button onclick="abrirModal('login')">Alquilar</button>
            <?php endif; ?>
        </div>
